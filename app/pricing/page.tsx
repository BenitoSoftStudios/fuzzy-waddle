          ...
          {[
            {
              ...
              a: 'No. Estimly works without any signup. Your estimate is built in your browser and downloaded instantly.',
            },
            {
              q: 'What does the watermarked PDF look like?',
              a: 'It has "SAMPLE" stamped across it and a small Estimly footer. Great for showing a client a draft, but not for submitting a final estimate.',
            },
            {
